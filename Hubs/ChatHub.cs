...
namespace Group5.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public async Task SendPrivate(string receiverName, string message)
        {
            ...
            {
                // Who is the sender;
                var sender = _Connections.Where(u => u.Email == IdentityName).First();
        ...
        public override Task OnConnectedAsync()
        {
            try
            {
                ...
                var userViewModel = _mapper.Map<Employee, UserViewModel>(user);
       ...
       private string IdentityName
        {
            get { return Context.User.FindFirstValue(ClaimTypes.NameIdentifier); }
        }
